 ...
 * Unfortunately, some of the bunnies have been weakened by their long imprisonment and can't run very fast. Their
 * friends are trying to help them, but this escape would go a lot faster if you also pitched in. The defensive
 * bulkhead doors have begun to close, and if you don't make it through in time, you'll be trapped! You need to grab
 ...
 * bunnies you don't pick up will be able to escape with you since they no longer have to carry the ones you did pick
 * up.) You can revisit different spots if you wish, and moving to the bulkhead doesn't mean you have to immediately
 ...
 * sets of bunnies of the same size, return the set of bunnies with the lowest prisoner IDs (as indexes) in sorted
 * order. The bunnies are represented as a sorted list by prisoner ID, with the first bunny being 0. There are at
 * most 5 bunnies, and time_limit is a non-negative integer that is at most 999.
 *
